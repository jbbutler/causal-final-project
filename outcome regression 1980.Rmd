...
census1980 <- census1980 %>% filter(county != 0)
...
TO DO:
Add background covariates (and figure out if they are one-hot encoding, etc.)
Add the outcome variable
Figure out why we're losing so much data in that one step at the beginning
