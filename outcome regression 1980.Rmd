...
census1980$livwmom <- census1980$momid != '0000'
```
...
census1980$othernh <- census1980$race != 1 & census1980$race != 0 & census1980$hispan == 0
census1980$blacknh <- census1980$race == 2 & census1980$hispan == 0
census1980$hispanic <- census1980$hispan > 0
census1980$female <- census1980$sex == 2
```
...
TO DO:
Add the outcome variable (grade-for-age status)
