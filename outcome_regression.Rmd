...
# First Outcome Regression: Grade-for-Age Status as Outcome

```{r}
# grab right ages
census_dat <- census1980 %>% filter(birthyr >= 1959, birthyr <= 1968)
census_dat
```

# Second Outcome Regression: Ultimate Educational Attainment as Outcome

# Third Outcome Regression: Labor Status as Outcome
